...
<div class="sidebar-fixed position-fixed"  style="height:100%; background-color: white;margin-top: 60px;width: 20%">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="toAddIntern" class="list-group-item list-group-item-action waves-effect">
            Add Intern</a>
        <a href="viewUneditedInterns" class="list-group-item list-group-item-action waves-effect">
            New Interns</a>   
        
        <a href="getInternFullDetails" class="list-group-item list-group-item-action waves-effect">
           Interns</a>
        <a href="hrProfile" class="list-group-item list-group-item-action waves-effect">
          Profile</a>
