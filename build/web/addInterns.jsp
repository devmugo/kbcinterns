    ...
    <body onload="insertValue();">
        ...
        <main>
            ...
            <div style="width:50%;margin:auto; background-color: white;">
                <form class="text-center border border-light p-5" action="addIntern" method="post">

                    <strong style=""> <b> Add Intern HR </b> </strong>
                    <br><br>
                    ...
                    <div class="form-row mb-4">
                        ...
                        <div class="col">
                            <a href="#" data-toggle="modal" data-target=""><img src="" height="30px" style="margin-left: -230px;margin-top: 25px"></a>
                        </div>
                    ...
                    <div class="form-row mb-4">
                        ...
                        <div class="col">
                            <a href="#" data-toggle="modal" data-target="#addrole"><img src="" height="30px" style="margin-left: -230px;margin-top: 25px"></a>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="addDprt" method="post">
                        ...
                        <div class="md-form mb-5">                                    
                            ...
                            <br>
                            <br>
                            <input type="text" name="dprt" id="defaultRegisterFormFirstName" class="form-control" placeholder="Department" style="max-width:90%">
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="addStation" method="post">
                        ...
                        <div class="md-form mb-5">                                    
                            ...
                            <br>
                            <br>
                            <input type="text" name="station" id="defaultRegisterFormFirstName" class="form-control" placeholder="Station" style="max-width:90%">
                        </div>
