<%-- 
    ...
    Created on : Aug 11, 2019, 12:51:39 PM
    Author     : AMO
--%>
...
<html lang="en">
    ...
    <main>
        ...
        <div style="width:50%;margin:1em auto; background-color: white;">
            <div>
                <h1 style="color: black;text-align: center" >Admins Profile</h1>
            </div>
            <br> <br>
            ...
            <div class="form-group row">
                ...
                <div class="col-xs-6 col"style="margin-left: 10em">
                    <label for="first_name"><h4>Name</h4></label>
                </div>
                <div class="col">
                    <input type="text" class="form-control"  value="${requestScope.name}" readonly style="margin-left: -60%">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col">
                    <input type="text" class="form-control"  value="${requestScope.username} " readonly style="margin-left: -60%">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col">
                    <input type="text" class="form-control"  value="${requestScope.station}" readonly style="margin-left: -60%">
                </div>
            </div>
