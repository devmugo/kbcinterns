...
<div class="sidebar-fixed position-fixed"  style="height:100%; background-color: white;margin-top: 60px;width: 20%">
    ...
    <div class="list-group list-group-flush">          
        ...
        <a href="addUser" class="list-group-item list-group-item-action waves-effect">
            Add User</a>
        <a href="viewUsers" class="list-group-item list-group-item-action waves-effect">
            Users</a>   
        <a href="viewStations" class="list-group-item list-group-item-action waves-effect">
            Stations</a>
        <a href="viewDprts" class="list-group-item list-group-item-action waves-effect">
            Departments</a>
        <a href="disabledUsers" class="list-group-item list-group-item-action waves-effect">
            Disabled Users</a> 
        <a href="adminProfile" class="list-group-item list-group-item-action waves-effect">
            Profile</a> 
